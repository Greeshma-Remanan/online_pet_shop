...
<h1 class="w3ls">UPDATE PROFILE</h1>
	...
	<div class="content-agileits">
		...
		<form action="../user_update_conn.php" method="post" data-toggle="validator" role="form">
		<div class="form-group w3layouts w3 w3l">
				<label for="" class="control-label">User Id</label>
				
				<center><tr><th><mark>USER ID:</mark></th><td><input type="number" name="userid" autofocus required readonly value=<?php session_start(); $userid = $_SESSION['userid']; echo $userid; ?>></td></center>
				<div class="help-block with-errors"></div>
			</div>
			<div class="form-group w3layouts w3 w3l">
				<label for="" class="control-label">Name</label>
				<input type="text" class="form-control" name="username" id="username" placeholder="User Name" data-error="Enter Your Name" pattern="[A-Za-z\s]+" required autofocus>
				<div class="help-block with-errors"></div>
			</div>
