				...
				<!--form-stars-here-->
						<div class="form-w3-agile">
							...
							<form action="login_conn.php" method="post">
								...
								<p class="p-bottom-w3ls">Forgot Password?<a class href="forgot_pass.php">  Click here</a></p>
								<p class="p-bottom-w3ls1">New User?<a href="../user/registration/registartionpage.html">  Register here</a></p>
								<p class="p-bottom-w3ls">Seller Sign UP?<a class href="../seller/seller_reg_temp/seller_registrationpage.php"> Register here</a></p>
								
								<div class="clear"></div>
								<div class="submit-w3l">
									<input type="submit" value="Login">
								</div>
								<center><a href="../user/web/homeindex.html"><b>HOME</b></center>
							</form>
