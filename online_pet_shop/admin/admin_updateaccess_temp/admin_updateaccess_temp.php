...
?>
<h1 class="w3ls">UPDATES ACCESSORIES</h1>

	<div class="content-agileits">
		
		<form action="../update_accessories_conn.php" method="post" data-toggle="validator" role="form">
		<div class="form-group w3layouts w3 w3l">
				<label for="" class="control-label">Accessories Id</label>
				<input type="text" class="form-control" name="accid" id="accid" value="<?php echo $accid?>" readonly required autofocus>
				<div class="help-block with-errors"></div>
			</div>
			<div class="form-group w3layouts w3 w3l">
				<label for="" class="control-label">Name</label>
				<input type="text" class="form-control" name="accesname" id="accesname" placeholder="Accessories Name" data-error="Enter Accessories Name"  pattern="[A-Za-z\s]+" required autofocus>
				<div class="help-block with-errors"></div>
			</div>
			...
			<div class="form-group w3l agileinfo wthree w3-agileits">
				...
				<input type="text" class="form-control" name="stocks" id="stocks" placeholder="Stocks" data-error="Enter StockQuantity" pattern="[0-9]+" required>
				<div class="help-block with-errors"></div>
			</div>
			...
			<button><a href="../admin_home_temp/admin_homepage.php">HOME</a></button>
