...
<body>
<h1 class="w3ls">ADD PETS</h1>
	<div class="content-agileits">
		<form action="../add_pet_conn.php" method="post" data-toggle="validator" role="form">
			<div class="form-group w3layouts w3 w3l">
				<label for="" class="control-label">Name</label>
				<input type="text" class="form-control" name="pname" id="pname" placeholder="Pet Name" data-error="Enter Accessories Name" pattern="[A-Za-z]" required autofocus>
				<div class="help-block with-errors"></div>
			</div>
			<div class="form-group agileits w3layouts w3">
			<label for="" class="control-label">Types</label>
                <input list="types" name="types" placeholder="Select From List" required pattern="[A-Za-z\s]+" title="Capital Letters Only">
                <datalist id="types">
                    <option value="DOG">
                    <option value="CAT">
                    <option value="BIRDS">
			...
			<div class="form-group w3l agileinfo wthree w3-agileits">
				...
				<input type="text" class="form-control" name="stock" id="stock" placeholder="Stocks" data-error="Enter StockQuantity" pattern="[0-9]+" required>
				<div class="help-block with-errors"></div>
			</div>
